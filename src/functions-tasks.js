 ...
 *
 */
const getArgumentsCount = (funcs) => funcs.map((f) => f.length);
// console.log(
//   getArgumentsCount([
//     function () {
 ...
 *
 */
const getPowerFunction = (exponent) => (func) => func ** exponent;
...
function logger(func, logFunc) {
  return function logWrap(...args) {
    ...
    try {
      ...
      logFunc(`${func.name}(${argsString}) ends with error: ${error}`);
